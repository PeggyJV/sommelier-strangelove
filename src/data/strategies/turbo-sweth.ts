...
export const turboSWETH: CellarData = {
  ...
  config: {
    ...
    customRewardWithoutAPY: {
      ...
      customRewardMessage: "12 PEARL per swETH",
      customRewardHeader: "Daily Reward Rate",
      customRewardAPYTooltip: "Daily Reward Rate: 12 PEARL per swETH",
      showRewards: false,
      showClaim: false,
      customRewardLongMessage:
        "Earn 12 PEARL per swETH of TVL deposited when you bond.",
