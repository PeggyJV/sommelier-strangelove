  ...
  faq: [
    {
      ...
      answer:
        "Yes, all smart contracts on Somm have been audited by an independent third-party auditor. And you can find the ENS of audit reports here <a style='border-bottom: 1px solid; border-color:white' href='https://www.somm.finance/audits' target='_blank'>sommelier.finance/audits</a>",
    },
    {
