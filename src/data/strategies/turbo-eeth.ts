...
export const turboeETH: CellarData = {
  ...
  config: {
    ...
    customReward2: {
      showAPY2: false,
      tokenSymbol2: "weETH",
      tokenDisplayName2: "weETH",
      tokenAddress2: "0xcd5fe23c85820f7b72d0926fc9b05b43e359b7ee",
      imagePath2: "/assets/icons/weETH.png",
      customRewardMessageTooltip2: "weETH rewards",
      customRewardMessage2: "weETH rewards",
      customRewardHeader2: "weETH rewards",
      ...
      customColumnHeader2: "weETH rewards",
      customColumnHeaderToolTip2: "weETH rewards",
      // customColumnValue2: "TEST",
      stakingDurationOverride2: new Date(
        Date.UTC(2024, 1, 3, 14, 0, 0, 0)
      ),
      showSommRewards2: true,
      customIconToolTipMsg2: "weETH rewards",
