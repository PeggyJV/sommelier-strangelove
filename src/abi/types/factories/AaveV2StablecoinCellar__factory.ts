...
import type {
  ...
  AaveV2StablecoinCellarInterface,
} from "../AaveV2StablecoinCellar";
    ...
    inputs: [
      {
        ...
        name: "assetWithFeeOnTransfer",
        type: "address",
      },
    ],
    name: "STATE_AssetUsesFeeOnTransfer",
    type: "error",
  },
  {
    inputs: [],
...
export class AaveV2StablecoinCellar__factory {
  static readonly abi = _abi;
  static createInterface(): AaveV2StablecoinCellarInterface {
    return new utils.Interface(_abi) as AaveV2StablecoinCellarInterface;
  }
  static connect(
    address: string,
