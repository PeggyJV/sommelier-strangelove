...
import type { GravityBridge, GravityBridgeInterface } from "../GravityBridge";
...
export class GravityBridge__factory {
  static readonly abi = _abi;
  static createInterface(): GravityBridgeInterface {
    return new utils.Interface(_abi) as GravityBridgeInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): GravityBridge {
    return new Contract(address, _abi, signerOrProvider) as GravityBridge;
  }
}
