...
export interface AaveV2StablecoinCellarInterface extends utils.Interface {
  functions: {
    ...
    "highWatermarkBalance()": FunctionFragment;
    ...
    "rebalance(address[9],uint256[3][4],uint256)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "highWatermarkBalance",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface AaveV2StablecoinCellar extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: AaveV2StablecoinCellarInterface;
  ...
  functions: {
    ...
    highWatermarkBalance(overrides?: CallOverrides): Promise<[BigNumber]>;
