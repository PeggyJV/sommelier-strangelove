          ...
          <TabPanels>
            ...
            <TabPanel {...tabPanelProps}>
              <Text>
                ...
                brilliant model that determines the precise moment that is best
                to capitalize on new market conditions. Their edge is compounded
                by Somm's unique ability to dynamically adjust in real time.
                Unlike traditional vault architecture, Cellars are not limited
                by rigid smart contract code that allows positions to be
                adjusted under a narrow set of circumstances. The Aave Strategy
                uses high-powered predictive analytics to respond instantly when
                opportunity arises. The old vault model is a tortoise that pokes
                its head out of its shell occasionally when conditions are safe.
                We are cheetahs on the savannah.
              </Text>
            </TabPanel>
          </TabPanels>
        </Tabs>
