...
export const PageHome = () => {
  ...
  return (
    <LayoutWithSidebar>
      <InfoBanner
        text={
          "A new SOMM incentive program for the Real Yield BTC vault will go to vote soon. If it passes, additional incentives will flow for 30 days beginning August 10th."
        }
      />
      <HStack mb="1.6rem">
        <HStack spacing="8px">
