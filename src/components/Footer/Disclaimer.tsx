    ...
    <Flex {...props}>
      <Box marginTop="64px" color="neutral.300" fontSize="xs">
        <Text marginBottom="1rem">
          ...
          only. Somm does not manage any portfolios. You must
          make an independent judgment as to whether to add liquidity
          to portfolios.
        </Text>
        <Text marginBottom="1rem">
          Users of the Somm website should familiarize themselves
        ...
        <Text marginBottom="1.5rem">
          ...
          no guarantee that the Somm Mainnet, including any
          software, products or token use cases mentioned on the
          website, will be built, or offered by Somm. In
